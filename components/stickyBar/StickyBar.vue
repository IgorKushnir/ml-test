<template>
  <div>
    <div ref="bar"><div class="bar" >
      <transition name="title">
        <h3 v-if="fixedBar">{{title}}</h3>
      </transition>
    </div></div>

    <div ref="barSticky">
      <div class="bar sticky" style="opacity: 1.5"  v-if="fixedBar">
        <div class="container">
          <div class="left">
            <StickyBarIcon v-on:click="$router.back()">
              <div class="icon-arrow-16 back"/>
            </StickyBarIcon>
            <transition name="title">
              <h3 v-if="fixedBar">{{title}}</h3>
            </transition>
          ...
          <div class="right">
            <StickyBarIcon><div class="icon-arrow-16"></div></StickyBarIcon>
            <StickyBarIcon><div class="icon-arrow-16"></div></StickyBarIcon>
          </div>
        </div>
      </div>
