...
<!--            <div v-if="discontinued" class="badge light_bg p-h-16 p-v-8 gray">Discontinued</div>-->
            ...
            <NuxtLink v-if="!discontinued"  :to="locale === 'pl' ? localePath('/request-an-appointment/flagship') : localePath('/request-an-appointment')" target="_self" class="button m-t-16 m-t-0-md m-b-24-md">
